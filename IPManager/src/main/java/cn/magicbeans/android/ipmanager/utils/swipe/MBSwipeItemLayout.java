 ...
 */
public class MBSwipeItemLayout extends FrameLayout {
    ...
    public MBSwipeItemLayout(Context context) {
        this(context, null);
    }

    public MBSwipeItemLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MBSwipeItemLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        mVelocity = ViewConfiguration.get(context).getScaledMinimumFlingVelocity();
        Log.e(TAG, "SwipeItemLayout: " + mTouchSlop + "---" + mVelocity );
    ...
    public interface SwipeListener {
        void onSwipeOpen(MBSwipeItemLayout view);

        void onSwipeClose(MBSwipeItemLayout view);
    }
}
