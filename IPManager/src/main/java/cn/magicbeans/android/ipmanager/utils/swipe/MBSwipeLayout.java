...
public class MBSwipeLayout extends ViewGroup {
    ...
    public MBSwipeLayout(Context context) {
        this(context, null);
    }

    public MBSwipeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MBSwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MBSwipeLayout);
        mPreview = a.getInt(R.styleable.MBSwipeLayout_preview, NO_PREVIEW);
        a.recycle();
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MBSwipeLayout.LayoutParams(getContext(), attrs);
    }
