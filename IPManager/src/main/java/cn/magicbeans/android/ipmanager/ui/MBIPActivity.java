...
public class MBIPActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        findViewById(R.id.mb_insert_ip_tv).setOnClickListener(this);
        findViewById(R.id.mb_insert_domain_tv).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.mb_insert_ip_tv) {
        ...
        } else if (v.getId() == R.id.mb_insert_domain_tv){
            Intent intent = new Intent(this, MBDomainEditActivity.class);
            intent.putExtra(MBIPContant.TYPE, MBIPContant.OPERATE.INSERT.ordinal());
            startActivityForResult(intent, MBIPContant.REQUEST_CODE);
